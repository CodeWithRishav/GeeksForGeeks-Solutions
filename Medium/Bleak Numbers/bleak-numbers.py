...
class Solution:
    def is_bleak(self, n):
        ...
        for candidate in range(n - num_bits, n + 1):
            ...
            # If the sum of candidate and its set bits count is equal to n, it's not bleak.
            if sum_of_bits == n:
                return 0

        # If no number was found in the range that satisfies the condition, n is bleak.
        return 1
